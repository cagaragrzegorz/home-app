...
const TramSchedule: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const current = tramScheduleData.timetables.find(timetable => timetable.isInEffect);
        ...
        <Card>
            ...
            <Card.Body>
                {loading ? (
                    ...
                    <>
                        <Card.Title style={{textAlign: "center"}}>Linia: 20 - Przystanek: Mały Płaszów
                            (id: {schedule.departureId.stopId})
                        </Card.Title>
                        ...
                        {schedule.timetables
                            .filter(timetable => timetable.isInEffect)
                            .map((timetable, index) => (
                                <Alert key={index} variant="success" className="mb-3">
                                    <strong>Obowiązujący rozkład:</strong> {timetable.dayName}
                                </Alert>
                            ))}
